...
#### 6. Exemplos
  ...
  - **Descrição**: A descrição é variável de acordo com o organizador(a) e o evento, portanto segue um template.
    ...
    ### Regras
      ...
      ii. Proibido acessar qualquer outro website que não seja o contest no VJudge. 
      iii. Proibido baderna.
      iv. Cada time pode usar apenas um PC.
      v. Material impresso pode ser consultado (livros, códigos impressos, caderno de programação, estrutura de dados, grafos, etc). É Também é recomendado o uso de permitido rascunho.
      ...
      **Para compilar em ... use ...**
      ...
      Os prêmios são:
      **1º Lugar** - Parabéns pela participação.
      **2º Lugar** - Parabéns pela participação.
      **3º Lugar** - Parabéns pela participação.
